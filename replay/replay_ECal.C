...
void replay_ECal(int run_number = 124, uint nev = -1, TString start_name = "e1209019", uint nseg = 0)
{
  //load SBS-offline
  ...
  */
  ...
  while(seg_ok) {
    ...
    analyzer->SetCutFile( "replay_ECal.cdef" );
    analyzer->SetOdefFile( "replay_ECal.odef" );
