...
void replay_gep_beamline(UInt_t runnum=10491, Long_t nevents=-1, Long_t firstevent=1, const char *fname_prefix="gep5", UInt_t firstsegment=0, UInt_t maxsegments=1, Int_t maxstream=2, Int_t pedestalmode=0, Int_t cmplots=0, Int_t usesbsgems=1)
{
  ...
  */
  ...
  if( nevents > 0 ){
    outfilename.Form( "%s/gep_beamline_%d_%ldk_events.root", prefix.Data(), runnum, (nevents/1000) );
    ...
    outfilename.Form( "%s/gep_beamline_%d_%ld_events.root", prefix.Data(), runnum, nevents );
  }
  ...
  analyzer->SetSummaryFile(Form("%s/gep_%d_%ld_nevents.log", prefix.Data(), runnum, nevents));
  ...
  if( usesbsgems == 0 ) odef_filename = "replay_beam.odef";
  ...
  TString cdef_filename = "replay_beam.cdef";
