...
// Thu Apr 10 09:49:46 2025 by ROOT version 6.30/04
// from TTree T/Hall A Analyzer Output DST
// found on file: /volatile/halla/sbs/puckett/g4sbs_output/GEP1/elastic/replayed/rootfiles/replayed_GEP1_elastic_all.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        earm_ecal_a_amp_p[33];   //[Ndata.earm.ecal.a_amp_p]
   Int_t           Ndata_earm_ecal_a_p;
   Double_t        earm_ecal_a_p[33];   //[Ndata.earm.ecal.a_p]
   Int_t           Ndata_earm_ecal_a_time;
   Double_t        earm_ecal_a_time[33];   //[Ndata.earm.ecal.a_time]
   Int_t           Ndata_earm_ecal_adccol;
   Double_t        earm_ecal_adccol[33];   //[Ndata.earm.ecal.adccol]
   Int_t           Ndata_earm_ecal_adcelemID;
   Double_t        earm_ecal_adcelemID[33];   //[Ndata.earm.ecal.adcelemID]
   Int_t           Ndata_earm_ecal_adcrow;
   Double_t        earm_ecal_adcrow[33];   //[Ndata.earm.ecal.adcrow]
   Int_t           Ndata_earm_ecal_adcxpos;
   Double_t        earm_ecal_adcxpos[33];   //[Ndata.earm.ecal.adcxpos]
   Int_t           Ndata_earm_ecal_adcypos;
   Double_t        earm_ecal_adcypos[33];   //[Ndata.earm.ecal.adcypos]
   Int_t           Ndata_earm_ecal_clus_adctime;
   Double_t        earm_ecal_clus_adctime[10];   //[Ndata.earm.ecal.clus.adctime]
   Int_t           Ndata_earm_ecal_clus_again;
   Double_t        earm_ecal_clus_again[10];   //[Ndata.earm.ecal.clus.again]
   Int_t           Ndata_earm_ecal_clus_atimeblk;
   Double_t        earm_ecal_clus_atimeblk[10];   //[Ndata.earm.ecal.clus.atimeblk]
   Int_t           Ndata_earm_ecal_clus_col;
   Double_t        earm_ecal_clus_col[10];   //[Ndata.earm.ecal.clus.col]
   Int_t           Ndata_earm_ecal_clus_col_goodtdc;
   Double_t        earm_ecal_clus_col_goodtdc[10];   //[Ndata.earm.ecal.clus.col_goodtdc]
   Int_t           Ndata_earm_ecal_clus_e;
   Double_t        earm_ecal_clus_e[10];   //[Ndata.earm.ecal.clus.e]
   Int_t           Ndata_earm_ecal_clus_e_goodtdc;
   Double_t        earm_ecal_clus_e_goodtdc[10];   //[Ndata.earm.ecal.clus.e_goodtdc]
   Int_t           Ndata_earm_ecal_clus_eblk;
   Double_t        earm_ecal_clus_eblk[10];   //[Ndata.earm.ecal.clus.eblk]
   Int_t           Ndata_earm_ecal_clus_eblk_goodtdc;
   Double_t        earm_ecal_clus_eblk_goodtdc[10];   //[Ndata.earm.ecal.clus.eblk_goodtdc]
   Int_t           Ndata_earm_ecal_clus_id;
   Double_t        earm_ecal_clus_id[10];   //[Ndata.earm.ecal.clus.id]
   Int_t           Ndata_earm_ecal_clus_id_goodtdc;
   Double_t        earm_ecal_clus_id_goodtdc[10];   //[Ndata.earm.ecal.clus.id_goodtdc]
   Int_t           Ndata_earm_ecal_clus_nblk;
   Double_t        earm_ecal_clus_nblk[10];   //[Ndata.earm.ecal.clus.nblk]
   Int_t           Ndata_earm_ecal_clus_nblk_goodtdc;
   Double_t        earm_ecal_clus_nblk_goodtdc[10];   //[Ndata.earm.ecal.clus.nblk_goodtdc]
   Int_t           Ndata_earm_ecal_clus_row;
   Double_t        earm_ecal_clus_row[10];   //[Ndata.earm.ecal.clus.row]
   Int_t           Ndata_earm_ecal_clus_row_goodtdc;
   Double_t        earm_ecal_clus_row_goodtdc[10];   //[Ndata.earm.ecal.clus.row_goodtdc]
   Int_t           Ndata_earm_ecal_clus_tdctime;
   Double_t        earm_ecal_clus_tdctime[10];   //[Ndata.earm.ecal.clus.tdctime]
   Int_t           Ndata_earm_ecal_clus_tdctime_tw;
   Double_t        earm_ecal_clus_tdctime_tw[10];   //[Ndata.earm.ecal.clus.tdctime_tw]
   Int_t           Ndata_earm_ecal_clus_tdctimeblk;
   Double_t        earm_ecal_clus_tdctimeblk[10];   //[Ndata.earm.ecal.clus.tdctimeblk]
   Int_t           Ndata_earm_ecal_clus_tdctimeblk_tw;
   Double_t        earm_ecal_clus_tdctimeblk_tw[10];   //[Ndata.earm.ecal.clus.tdctimeblk_tw]
   Int_t           Ndata_earm_ecal_clus_x;
   Double_t        earm_ecal_clus_x[10];   //[Ndata.earm.ecal.clus.x]
   Int_t           Ndata_earm_ecal_clus_y;
   Double_t        earm_ecal_clus_y[10];   //[Ndata.earm.ecal.clus.y]
   Int_t           Ndata_earm_ecal_clus_blk_again;
   Double_t        earm_ecal_clus_blk_again[30];   //[Ndata.earm.ecal.clus_blk.again]
   Int_t           Ndata_earm_ecal_clus_blk_atime;
   Double_t        earm_ecal_clus_blk_atime[30];   //[Ndata.earm.ecal.clus_blk.atime]
   Int_t           Ndata_earm_ecal_clus_blk_col;
   Double_t        earm_ecal_clus_blk_col[30];   //[Ndata.earm.ecal.clus_blk.col]
   Int_t           Ndata_earm_ecal_clus_blk_e;
   Double_t        earm_ecal_clus_blk_e[30];   //[Ndata.earm.ecal.clus_blk.e]
   Int_t           Ndata_earm_ecal_clus_blk_id;
   Double_t        earm_ecal_clus_blk_id[30];   //[Ndata.earm.ecal.clus_blk.id]
   Int_t           Ndata_earm_ecal_clus_blk_row;
   Double_t        earm_ecal_clus_blk_row[30];   //[Ndata.earm.ecal.clus_blk.row]
   Int_t           Ndata_earm_ecal_clus_blk_tdctime;
   Double_t        earm_ecal_clus_blk_tdctime[30];   //[Ndata.earm.ecal.clus_blk.tdctime]
   Int_t           Ndata_earm_ecal_clus_blk_tdctime_tw;
   Double_t        earm_ecal_clus_blk_tdctime_tw[30];   //[Ndata.earm.ecal.clus_blk.tdctime_tw]
   Int_t           Ndata_earm_ecal_clus_blk_x;
   Double_t        earm_ecal_clus_blk_x[30];   //[Ndata.earm.ecal.clus_blk.x]
   Int_t           Ndata_earm_ecal_clus_blk_y;
   Double_t        earm_ecal_clus_blk_y[30];   //[Ndata.earm.ecal.clus_blk.y]
   Int_t           Ndata_earm_ecal_ped;
   Double_t        earm_ecal_ped[33];   //[Ndata.earm.ecal.ped]
   ...
   Double_t        sbs_gemFPP_hit_ADCU[25];   //[Ndata.sbs.gemFPP.hit.ADCU]
   Int_t           Ndata_sbs_gemFPP_hit_ADCU_deconv;
   Double_t        sbs_gemFPP_hit_ADCU_deconv[25];   //[Ndata.sbs.gemFPP.hit.ADCU_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_ADCV;
   Double_t        sbs_gemFPP_hit_ADCV[25];   //[Ndata.sbs.gemFPP.hit.ADCV]
   Int_t           Ndata_sbs_gemFPP_hit_ADCV_deconv;
   Double_t        sbs_gemFPP_hit_ADCV_deconv[25];   //[Ndata.sbs.gemFPP.hit.ADCV_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_ADCasym;
   Double_t        sbs_gemFPP_hit_ADCasym[25];   //[Ndata.sbs.gemFPP.hit.ADCasym]
   Int_t           Ndata_sbs_gemFPP_hit_ADCasym_deconv;
   Double_t        sbs_gemFPP_hit_ADCasym_deconv[25];   //[Ndata.sbs.gemFPP.hit.ADCasym_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_ADCavg;
   Double_t        sbs_gemFPP_hit_ADCavg[25];   //[Ndata.sbs.gemFPP.hit.ADCavg]
   Int_t           Ndata_sbs_gemFPP_hit_ADCavg_deconv;
   Double_t        sbs_gemFPP_hit_ADCavg_deconv[25];   //[Ndata.sbs.gemFPP.hit.ADCavg_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac0_Umax;
   Double_t        sbs_gemFPP_hit_ADCfrac0_Umax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac0_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac0_Vmax;
   Double_t        sbs_gemFPP_hit_ADCfrac0_Vmax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac0_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac1_Umax;
   Double_t        sbs_gemFPP_hit_ADCfrac1_Umax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac1_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac1_Vmax;
   Double_t        sbs_gemFPP_hit_ADCfrac1_Vmax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac1_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac2_Umax;
   Double_t        sbs_gemFPP_hit_ADCfrac2_Umax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac2_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac2_Vmax;
   Double_t        sbs_gemFPP_hit_ADCfrac2_Vmax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac2_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac3_Umax;
   Double_t        sbs_gemFPP_hit_ADCfrac3_Umax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac3_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac3_Vmax;
   Double_t        sbs_gemFPP_hit_ADCfrac3_Vmax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac3_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac4_Umax;
   Double_t        sbs_gemFPP_hit_ADCfrac4_Umax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac4_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac4_Vmax;
   Double_t        sbs_gemFPP_hit_ADCfrac4_Vmax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac4_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac5_Umax;
   Double_t        sbs_gemFPP_hit_ADCfrac5_Umax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac5_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCfrac5_Vmax;
   Double_t        sbs_gemFPP_hit_ADCfrac5_Vmax[25];   //[Ndata.sbs.gemFPP.hit.ADCfrac5_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_ADCmaxcomboUclust_deconv;
   Double_t        sbs_gemFPP_hit_ADCmaxcomboUclust_deconv[25];   //[Ndata.sbs.gemFPP.hit.ADCmaxcomboUclust_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_ADCmaxcomboVclust_deconv;
   Double_t        sbs_gemFPP_hit_ADCmaxcomboVclust_deconv[25];   //[Ndata.sbs.gemFPP.hit.ADCmaxcomboVclust_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_ADCmaxsampU;
   Double_t        sbs_gemFPP_hit_ADCmaxsampU[25];   //[Ndata.sbs.gemFPP.hit.ADCmaxsampU]
   Int_t           Ndata_sbs_gemFPP_hit_ADCmaxsampUclust;
   Double_t        sbs_gemFPP_hit_ADCmaxsampUclust[25];   //[Ndata.sbs.gemFPP.hit.ADCmaxsampUclust]
   Int_t           Ndata_sbs_gemFPP_hit_ADCmaxsampUclust_deconv;
   Double_t        sbs_gemFPP_hit_ADCmaxsampUclust_deconv[25];   //[Ndata.sbs.gemFPP.hit.ADCmaxsampUclust_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_ADCmaxsampV;
   Double_t        sbs_gemFPP_hit_ADCmaxsampV[25];   //[Ndata.sbs.gemFPP.hit.ADCmaxsampV]
   Int_t           Ndata_sbs_gemFPP_hit_ADCmaxsampVclust;
   Double_t        sbs_gemFPP_hit_ADCmaxsampVclust[25];   //[Ndata.sbs.gemFPP.hit.ADCmaxsampVclust]
   Int_t           Ndata_sbs_gemFPP_hit_ADCmaxsampVclust_deconv;
   Double_t        sbs_gemFPP_hit_ADCmaxsampVclust_deconv[25];   //[Ndata.sbs.gemFPP.hit.ADCmaxsampVclust_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_ADCmaxstripU;
   Double_t        sbs_gemFPP_hit_ADCmaxstripU[25];   //[Ndata.sbs.gemFPP.hit.ADCmaxstripU]
   Int_t           Ndata_sbs_gemFPP_hit_ADCmaxstripV;
   Double_t        sbs_gemFPP_hit_ADCmaxstripV[25];   //[Ndata.sbs.gemFPP.hit.ADCmaxstripV]
   Int_t           Ndata_sbs_gemFPP_hit_BUILD_ALL_SAMPLES_U;
   Double_t        sbs_gemFPP_hit_BUILD_ALL_SAMPLES_U[25];   //[Ndata.sbs.gemFPP.hit.BUILD_ALL_SAMPLES_U]
   Int_t           Ndata_sbs_gemFPP_hit_BUILD_ALL_SAMPLES_V;
   Double_t        sbs_gemFPP_hit_BUILD_ALL_SAMPLES_V[25];   //[Ndata.sbs.gemFPP.hit.BUILD_ALL_SAMPLES_V]
   Int_t           Ndata_sbs_gemFPP_hit_CM_GOOD_U;
   Double_t        sbs_gemFPP_hit_CM_GOOD_U[25];   //[Ndata.sbs.gemFPP.hit.CM_GOOD_U]
   Int_t           Ndata_sbs_gemFPP_hit_CM_GOOD_V;
   Double_t        sbs_gemFPP_hit_CM_GOOD_V[25];   //[Ndata.sbs.gemFPP.hit.CM_GOOD_V]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC0_Umax;
   Double_t        sbs_gemFPP_hit_DeconvADC0_Umax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC0_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC0_Vmax;
   Double_t        sbs_gemFPP_hit_DeconvADC0_Vmax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC0_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC1_Umax;
   Double_t        sbs_gemFPP_hit_DeconvADC1_Umax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC1_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC1_Vmax;
   Double_t        sbs_gemFPP_hit_DeconvADC1_Vmax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC1_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC2_Umax;
   Double_t        sbs_gemFPP_hit_DeconvADC2_Umax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC2_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC2_Vmax;
   Double_t        sbs_gemFPP_hit_DeconvADC2_Vmax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC2_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC3_Umax;
   Double_t        sbs_gemFPP_hit_DeconvADC3_Umax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC3_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC3_Vmax;
   Double_t        sbs_gemFPP_hit_DeconvADC3_Vmax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC3_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC4_Umax;
   Double_t        sbs_gemFPP_hit_DeconvADC4_Umax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC4_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC4_Vmax;
   Double_t        sbs_gemFPP_hit_DeconvADC4_Vmax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC4_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC5_Umax;
   Double_t        sbs_gemFPP_hit_DeconvADC5_Umax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC5_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADC5_Vmax;
   Double_t        sbs_gemFPP_hit_DeconvADC5_Vmax[25];   //[Ndata.sbs.gemFPP.hit.DeconvADC5_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADCmaxcomboU;
   Double_t        sbs_gemFPP_hit_DeconvADCmaxcomboU[25];   //[Ndata.sbs.gemFPP.hit.DeconvADCmaxcomboU]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADCmaxcomboV;
   Double_t        sbs_gemFPP_hit_DeconvADCmaxcomboV[25];   //[Ndata.sbs.gemFPP.hit.DeconvADCmaxcomboV]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADCmaxsampU;
   Double_t        sbs_gemFPP_hit_DeconvADCmaxsampU[25];   //[Ndata.sbs.gemFPP.hit.DeconvADCmaxsampU]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADCmaxsampV;
   Double_t        sbs_gemFPP_hit_DeconvADCmaxsampV[25];   //[Ndata.sbs.gemFPP.hit.DeconvADCmaxsampV]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADCmaxstripU;
   Double_t        sbs_gemFPP_hit_DeconvADCmaxstripU[25];   //[Ndata.sbs.gemFPP.hit.DeconvADCmaxstripU]
   Int_t           Ndata_sbs_gemFPP_hit_DeconvADCmaxstripV;
   Double_t        sbs_gemFPP_hit_DeconvADCmaxstripV[25];   //[Ndata.sbs.gemFPP.hit.DeconvADCmaxstripV]
   Int_t           Ndata_sbs_gemFPP_hit_ENABLE_CM_U;
   Double_t        sbs_gemFPP_hit_ENABLE_CM_U[25];   //[Ndata.sbs.gemFPP.hit.ENABLE_CM_U]
   Int_t           Ndata_sbs_gemFPP_hit_ENABLE_CM_V;
   Double_t        sbs_gemFPP_hit_ENABLE_CM_V[25];   //[Ndata.sbs.gemFPP.hit.ENABLE_CM_V]
   Int_t           Ndata_sbs_gemFPP_hit_TSchi2_Umax;
   Double_t        sbs_gemFPP_hit_TSchi2_Umax[25];   //[Ndata.sbs.gemFPP.hit.TSchi2_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_TSchi2_Vmax;
   Double_t        sbs_gemFPP_hit_TSchi2_Vmax[25];   //[Ndata.sbs.gemFPP.hit.TSchi2_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_TSprob_Umax;
   Double_t        sbs_gemFPP_hit_TSprob_Umax[25];   //[Ndata.sbs.gemFPP.hit.TSprob_Umax]
   Int_t           Ndata_sbs_gemFPP_hit_TSprob_Vmax;
   Double_t        sbs_gemFPP_hit_TSprob_Vmax[25];   //[Ndata.sbs.gemFPP.hit.TSprob_Vmax]
   Int_t           Ndata_sbs_gemFPP_hit_Tavg;
   Double_t        sbs_gemFPP_hit_Tavg[25];   //[Ndata.sbs.gemFPP.hit.Tavg]
   Int_t           Ndata_sbs_gemFPP_hit_Tavg_corr;
   Double_t        sbs_gemFPP_hit_Tavg_corr[25];   //[Ndata.sbs.gemFPP.hit.Tavg_corr]
   Int_t           Ndata_sbs_gemFPP_hit_Tavg_deconv;
   Double_t        sbs_gemFPP_hit_Tavg_deconv[25];   //[Ndata.sbs.gemFPP.hit.Tavg_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_Tavg_fit;
   Double_t        sbs_gemFPP_hit_Tavg_fit[25];   //[Ndata.sbs.gemFPP.hit.Tavg_fit]
   Int_t           Ndata_sbs_gemFPP_hit_Ugain;
   Double_t        sbs_gemFPP_hit_Ugain[25];   //[Ndata.sbs.gemFPP.hit.Ugain]
   Int_t           Ndata_sbs_gemFPP_hit_Utime;
   Double_t        sbs_gemFPP_hit_Utime[25];   //[Ndata.sbs.gemFPP.hit.Utime]
   Int_t           Ndata_sbs_gemFPP_hit_UtimeDeconv;
   Double_t        sbs_gemFPP_hit_UtimeDeconv[25];   //[Ndata.sbs.gemFPP.hit.UtimeDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_UtimeFit;
   Double_t        sbs_gemFPP_hit_UtimeFit[25];   //[Ndata.sbs.gemFPP.hit.UtimeFit]
   Int_t           Ndata_sbs_gemFPP_hit_UtimeMaxStrip;
   Double_t        sbs_gemFPP_hit_UtimeMaxStrip[25];   //[Ndata.sbs.gemFPP.hit.UtimeMaxStrip]
   Int_t           Ndata_sbs_gemFPP_hit_UtimeMaxStripDeconv;
   Double_t        sbs_gemFPP_hit_UtimeMaxStripDeconv[25];   //[Ndata.sbs.gemFPP.hit.UtimeMaxStripDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_UtimeMaxStripFit;
   Double_t        sbs_gemFPP_hit_UtimeMaxStripFit[25];   //[Ndata.sbs.gemFPP.hit.UtimeMaxStripFit]
   Int_t           Ndata_sbs_gemFPP_hit_Vgain;
   Double_t        sbs_gemFPP_hit_Vgain[25];   //[Ndata.sbs.gemFPP.hit.Vgain]
   Int_t           Ndata_sbs_gemFPP_hit_Vtime;
   Double_t        sbs_gemFPP_hit_Vtime[25];   //[Ndata.sbs.gemFPP.hit.Vtime]
   Int_t           Ndata_sbs_gemFPP_hit_VtimeDeconv;
   Double_t        sbs_gemFPP_hit_VtimeDeconv[25];   //[Ndata.sbs.gemFPP.hit.VtimeDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_VtimeFit;
   Double_t        sbs_gemFPP_hit_VtimeFit[25];   //[Ndata.sbs.gemFPP.hit.VtimeFit]
   Int_t           Ndata_sbs_gemFPP_hit_VtimeMaxStrip;
   Double_t        sbs_gemFPP_hit_VtimeMaxStrip[25];   //[Ndata.sbs.gemFPP.hit.VtimeMaxStrip]
   Int_t           Ndata_sbs_gemFPP_hit_VtimeMaxStripDeconv;
   Double_t        sbs_gemFPP_hit_VtimeMaxStripDeconv[25];   //[Ndata.sbs.gemFPP.hit.VtimeMaxStripDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_VtimeMaxStripFit;
   Double_t        sbs_gemFPP_hit_VtimeMaxStripFit[25];   //[Ndata.sbs.gemFPP.hit.VtimeMaxStripFit]
   Int_t           Ndata_sbs_gemFPP_hit_adc_id_U;
   Double_t        sbs_gemFPP_hit_adc_id_U[25];   //[Ndata.sbs.gemFPP.hit.adc_id_U]
   Int_t           Ndata_sbs_gemFPP_hit_adc_id_V;
   Double_t        sbs_gemFPP_hit_adc_id_V[25];   //[Ndata.sbs.gemFPP.hit.adc_id_V]
   Int_t           Ndata_sbs_gemFPP_hit_ccor_clust;
   Double_t        sbs_gemFPP_hit_ccor_clust[25];   //[Ndata.sbs.gemFPP.hit.ccor_clust]
   Int_t           Ndata_sbs_gemFPP_hit_ccor_clust_deconv;
   Double_t        sbs_gemFPP_hit_ccor_clust_deconv[25];   //[Ndata.sbs.gemFPP.hit.ccor_clust_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_ccor_strip;
   Double_t        sbs_gemFPP_hit_ccor_strip[25];   //[Ndata.sbs.gemFPP.hit.ccor_strip]
   Int_t           Ndata_sbs_gemFPP_hit_ccor_strip_deconv;
   Double_t        sbs_gemFPP_hit_ccor_strip_deconv[25];   //[Ndata.sbs.gemFPP.hit.ccor_strip_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_crate_U;
   Double_t        sbs_gemFPP_hit_crate_U[25];   //[Ndata.sbs.gemFPP.hit.crate_U]
   Int_t           Ndata_sbs_gemFPP_hit_crate_V;
   Double_t        sbs_gemFPP_hit_crate_V[25];   //[Ndata.sbs.gemFPP.hit.crate_V]
   Int_t           Ndata_sbs_gemFPP_hit_deltat;
   Double_t        sbs_gemFPP_hit_deltat[25];   //[Ndata.sbs.gemFPP.hit.deltat]
   Int_t           Ndata_sbs_gemFPP_hit_deltat_deconv;
   Double_t        sbs_gemFPP_hit_deltat_deconv[25];   //[Ndata.sbs.gemFPP.hit.deltat_deconv]
   Int_t           Ndata_sbs_gemFPP_hit_deltat_fit;
   Double_t        sbs_gemFPP_hit_deltat_fit[25];   //[Ndata.sbs.gemFPP.hit.deltat_fit]
   Int_t           Ndata_sbs_gemFPP_hit_eresidu;
   Double_t        sbs_gemFPP_hit_eresidu[25];   //[Ndata.sbs.gemFPP.hit.eresidu]
   Int_t           Ndata_sbs_gemFPP_hit_eresidv;
   Double_t        sbs_gemFPP_hit_eresidv[25];   //[Ndata.sbs.gemFPP.hit.eresidv]
   Int_t           Ndata_sbs_gemFPP_hit_icombomaxUclustDeconv;
   Double_t        sbs_gemFPP_hit_icombomaxUclustDeconv[25];   //[Ndata.sbs.gemFPP.hit.icombomaxUclustDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_icombomaxUstripDeconv;
   Double_t        sbs_gemFPP_hit_icombomaxUstripDeconv[25];   //[Ndata.sbs.gemFPP.hit.icombomaxUstripDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_icombomaxVclustDeconv;
   Double_t        sbs_gemFPP_hit_icombomaxVclustDeconv[25];   //[Ndata.sbs.gemFPP.hit.icombomaxVclustDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_icombomaxVstripDeconv;
   Double_t        sbs_gemFPP_hit_icombomaxVstripDeconv[25];   //[Ndata.sbs.gemFPP.hit.icombomaxVstripDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_isampmaxUclust;
   Double_t        sbs_gemFPP_hit_isampmaxUclust[25];   //[Ndata.sbs.gemFPP.hit.isampmaxUclust]
   Int_t           Ndata_sbs_gemFPP_hit_isampmaxUclustDeconv;
   Double_t        sbs_gemFPP_hit_isampmaxUclustDeconv[25];   //[Ndata.sbs.gemFPP.hit.isampmaxUclustDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_isampmaxUstrip;
   Double_t        sbs_gemFPP_hit_isampmaxUstrip[25];   //[Ndata.sbs.gemFPP.hit.isampmaxUstrip]
   Int_t           Ndata_sbs_gemFPP_hit_isampmaxUstripDeconv;
   Double_t        sbs_gemFPP_hit_isampmaxUstripDeconv[25];   //[Ndata.sbs.gemFPP.hit.isampmaxUstripDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_isampmaxVclust;
   Double_t        sbs_gemFPP_hit_isampmaxVclust[25];   //[Ndata.sbs.gemFPP.hit.isampmaxVclust]
   Int_t           Ndata_sbs_gemFPP_hit_isampmaxVclustDeconv;
   Double_t        sbs_gemFPP_hit_isampmaxVclustDeconv[25];   //[Ndata.sbs.gemFPP.hit.isampmaxVclustDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_isampmaxVstrip;
   Double_t        sbs_gemFPP_hit_isampmaxVstrip[25];   //[Ndata.sbs.gemFPP.hit.isampmaxVstrip]
   Int_t           Ndata_sbs_gemFPP_hit_isampmaxVstripDeconv;
   Double_t        sbs_gemFPP_hit_isampmaxVstripDeconv[25];   //[Ndata.sbs.gemFPP.hit.isampmaxVstripDeconv]
   Int_t           Ndata_sbs_gemFPP_hit_layer;
   Double_t        sbs_gemFPP_hit_layer[25];   //[Ndata.sbs.gemFPP.hit.layer]
   Int_t           Ndata_sbs_gemFPP_hit_module;
   Double_t        sbs_gemFPP_hit_module[25];   //[Ndata.sbs.gemFPP.hit.module]
   Int_t           Ndata_sbs_gemFPP_hit_mpd_U;
   Double_t        sbs_gemFPP_hit_mpd_U[25];   //[Ndata.sbs.gemFPP.hit.mpd_U]
   Int_t           Ndata_sbs_gemFPP_hit_mpd_V;
   Double_t        sbs_gemFPP_hit_mpd_V[25];   //[Ndata.sbs.gemFPP.hit.mpd_V]
   Int_t           Ndata_sbs_gemFPP_hit_nstripu;
   Double_t        sbs_gemFPP_hit_nstripu[25];   //[Ndata.sbs.gemFPP.hit.nstripu]
   Int_t           Ndata_sbs_gemFPP_hit_nstripv;
   Double_t        sbs_gemFPP_hit_nstripv[25];   //[Ndata.sbs.gemFPP.hit.nstripv]
   Int_t           Ndata_sbs_gemFPP_hit_residu;
   Double_t        sbs_gemFPP_hit_residu[25];   //[Ndata.sbs.gemFPP.hit.residu]
   Int_t           Ndata_sbs_gemFPP_hit_residv;
   Double_t        sbs_gemFPP_hit_residv[25];   //[Ndata.sbs.gemFPP.hit.residv]
   Int_t           Ndata_sbs_gemFPP_hit_trackindex;
   Double_t        sbs_gemFPP_hit_trackindex[25];   //[Ndata.sbs.gemFPP.hit.trackindex]
   Int_t           Ndata_sbs_gemFPP_hit_u;
   Double_t        sbs_gemFPP_hit_u[25];   //[Ndata.sbs.gemFPP.hit.u]
   Int_t           Ndata_sbs_gemFPP_hit_umoment;
   Double_t        sbs_gemFPP_hit_umoment[25];   //[Ndata.sbs.gemFPP.hit.umoment]
   Int_t           Ndata_sbs_gemFPP_hit_usigma;
   Double_t        sbs_gemFPP_hit_usigma[25];   //[Ndata.sbs.gemFPP.hit.usigma]
   Int_t           Ndata_sbs_gemFPP_hit_ustriphi;
   Double_t        sbs_gemFPP_hit_ustriphi[25];   //[Ndata.sbs.gemFPP.hit.ustriphi]
   Int_t           Ndata_sbs_gemFPP_hit_ustriplo;
   Double_t        sbs_gemFPP_hit_ustriplo[25];   //[Ndata.sbs.gemFPP.hit.ustriplo]
   Int_t           Ndata_sbs_gemFPP_hit_ustripmax;
   Double_t        sbs_gemFPP_hit_ustripmax[25];   //[Ndata.sbs.gemFPP.hit.ustripmax]
   Int_t           Ndata_sbs_gemFPP_hit_v;
   Double_t        sbs_gemFPP_hit_v[25];   //[Ndata.sbs.gemFPP.hit.v]
   Int_t           Ndata_sbs_gemFPP_hit_vmoment;
   Double_t        sbs_gemFPP_hit_vmoment[25];   //[Ndata.sbs.gemFPP.hit.vmoment]
   Int_t           Ndata_sbs_gemFPP_hit_vsigma;
   Double_t        sbs_gemFPP_hit_vsigma[25];   //[Ndata.sbs.gemFPP.hit.vsigma]
   Int_t           Ndata_sbs_gemFPP_hit_vstriphi;
   Double_t        sbs_gemFPP_hit_vstriphi[25];   //[Ndata.sbs.gemFPP.hit.vstriphi]
   Int_t           Ndata_sbs_gemFPP_hit_vstriplo;
   Double_t        sbs_gemFPP_hit_vstriplo[25];   //[Ndata.sbs.gemFPP.hit.vstriplo]
   Int_t           Ndata_sbs_gemFPP_hit_vstripmax;
   Double_t        sbs_gemFPP_hit_vstripmax[25];   //[Ndata.sbs.gemFPP.hit.vstripmax]
   Int_t           Ndata_sbs_gemFPP_hit_xglobal;
   Double_t        sbs_gemFPP_hit_xglobal[25];   //[Ndata.sbs.gemFPP.hit.xglobal]
   Int_t           Ndata_sbs_gemFPP_hit_xlocal;
   Double_t        sbs_gemFPP_hit_xlocal[25];   //[Ndata.sbs.gemFPP.hit.xlocal]
   Int_t           Ndata_sbs_gemFPP_hit_yglobal;
   Double_t        sbs_gemFPP_hit_yglobal[25];   //[Ndata.sbs.gemFPP.hit.yglobal]
   Int_t           Ndata_sbs_gemFPP_hit_ylocal;
   Double_t        sbs_gemFPP_hit_ylocal[25];   //[Ndata.sbs.gemFPP.hit.ylocal]
   Int_t           Ndata_sbs_gemFPP_hit_zglobal;
   Double_t        sbs_gemFPP_hit_zglobal[25];   //[Ndata.sbs.gemFPP.hit.zglobal]
   ...
   Double_t        sbs_gemFPP_track_chi2ndf[4];   //[Ndata.sbs.gemFPP.track.chi2ndf]
   Int_t           Ndata_sbs_gemFPP_track_chi2ndf_hitquality;
   Double_t        sbs_gemFPP_track_chi2ndf_hitquality[4];   //[Ndata.sbs.gemFPP.track.chi2ndf_hitquality]
   Int_t           Ndata_sbs_gemFPP_track_ngoodhits;
   Double_t        sbs_gemFPP_track_ngoodhits[4];   //[Ndata.sbs.gemFPP.track.ngoodhits]
   Int_t           Ndata_sbs_gemFPP_track_nhits;
   Double_t        sbs_gemFPP_track_nhits[4];   //[Ndata.sbs.gemFPP.track.nhits]
   Int_t           Ndata_sbs_gemFPP_track_phi;
   Double_t        sbs_gemFPP_track_phi[4];   //[Ndata.sbs.gemFPP.track.phi]
   Int_t           Ndata_sbs_gemFPP_track_sclose;
   Double_t        sbs_gemFPP_track_sclose[4];   //[Ndata.sbs.gemFPP.track.sclose]
   Int_t           Ndata_sbs_gemFPP_track_t0;
   Double_t        sbs_gemFPP_track_t0[4];   //[Ndata.sbs.gemFPP.track.t0]
   Int_t           Ndata_sbs_gemFPP_track_theta;
   Double_t        sbs_gemFPP_track_theta[4];   //[Ndata.sbs.gemFPP.track.theta]
   Int_t           Ndata_sbs_gemFPP_track_x;
   Double_t        sbs_gemFPP_track_x[4];   //[Ndata.sbs.gemFPP.track.x]
   Int_t           Ndata_sbs_gemFPP_track_xp;
   Double_t        sbs_gemFPP_track_xp[4];   //[Ndata.sbs.gemFPP.track.xp]
   Int_t           Ndata_sbs_gemFPP_track_y;
   Double_t        sbs_gemFPP_track_y[4];   //[Ndata.sbs.gemFPP.track.y]
   Int_t           Ndata_sbs_gemFPP_track_yp;
   Double_t        sbs_gemFPP_track_yp[4];   //[Ndata.sbs.gemFPP.track.yp]
   Int_t           Ndata_sbs_gemFPP_track_zclose;
   Double_t        sbs_gemFPP_track_zclose[4];   //[Ndata.sbs.gemFPP.track.zclose]
   Int_t           Ndata_sbs_gemFT_hit_ADCU;
   Double_t        sbs_gemFT_hit_ADCU[14];   //[Ndata.sbs.gemFT.hit.ADCU]
   Int_t           Ndata_sbs_gemFT_hit_ADCU_deconv;
   Double_t        sbs_gemFT_hit_ADCU_deconv[14];   //[Ndata.sbs.gemFT.hit.ADCU_deconv]
   Int_t           Ndata_sbs_gemFT_hit_ADCV;
   Double_t        sbs_gemFT_hit_ADCV[14];   //[Ndata.sbs.gemFT.hit.ADCV]
   Int_t           Ndata_sbs_gemFT_hit_ADCV_deconv;
   Double_t        sbs_gemFT_hit_ADCV_deconv[14];   //[Ndata.sbs.gemFT.hit.ADCV_deconv]
   Int_t           Ndata_sbs_gemFT_hit_ADCasym;
   Double_t        sbs_gemFT_hit_ADCasym[14];   //[Ndata.sbs.gemFT.hit.ADCasym]
   Int_t           Ndata_sbs_gemFT_hit_ADCasym_deconv;
   Double_t        sbs_gemFT_hit_ADCasym_deconv[14];   //[Ndata.sbs.gemFT.hit.ADCasym_deconv]
   Int_t           Ndata_sbs_gemFT_hit_ADCavg;
   Double_t        sbs_gemFT_hit_ADCavg[14];   //[Ndata.sbs.gemFT.hit.ADCavg]
   Int_t           Ndata_sbs_gemFT_hit_ADCavg_deconv;
   Double_t        sbs_gemFT_hit_ADCavg_deconv[14];   //[Ndata.sbs.gemFT.hit.ADCavg_deconv]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac0_Umax;
   Double_t        sbs_gemFT_hit_ADCfrac0_Umax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac0_Umax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac0_Vmax;
   Double_t        sbs_gemFT_hit_ADCfrac0_Vmax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac0_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac1_Umax;
   Double_t        sbs_gemFT_hit_ADCfrac1_Umax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac1_Umax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac1_Vmax;
   Double_t        sbs_gemFT_hit_ADCfrac1_Vmax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac1_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac2_Umax;
   Double_t        sbs_gemFT_hit_ADCfrac2_Umax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac2_Umax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac2_Vmax;
   Double_t        sbs_gemFT_hit_ADCfrac2_Vmax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac2_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac3_Umax;
   Double_t        sbs_gemFT_hit_ADCfrac3_Umax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac3_Umax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac3_Vmax;
   Double_t        sbs_gemFT_hit_ADCfrac3_Vmax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac3_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac4_Umax;
   Double_t        sbs_gemFT_hit_ADCfrac4_Umax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac4_Umax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac4_Vmax;
   Double_t        sbs_gemFT_hit_ADCfrac4_Vmax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac4_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac5_Umax;
   Double_t        sbs_gemFT_hit_ADCfrac5_Umax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac5_Umax]
   Int_t           Ndata_sbs_gemFT_hit_ADCfrac5_Vmax;
   Double_t        sbs_gemFT_hit_ADCfrac5_Vmax[14];   //[Ndata.sbs.gemFT.hit.ADCfrac5_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_ADCmaxcomboUclust_deconv;
   Double_t        sbs_gemFT_hit_ADCmaxcomboUclust_deconv[14];   //[Ndata.sbs.gemFT.hit.ADCmaxcomboUclust_deconv]
   Int_t           Ndata_sbs_gemFT_hit_ADCmaxcomboVclust_deconv;
   Double_t        sbs_gemFT_hit_ADCmaxcomboVclust_deconv[14];   //[Ndata.sbs.gemFT.hit.ADCmaxcomboVclust_deconv]
   Int_t           Ndata_sbs_gemFT_hit_ADCmaxsampU;
   Double_t        sbs_gemFT_hit_ADCmaxsampU[14];   //[Ndata.sbs.gemFT.hit.ADCmaxsampU]
   Int_t           Ndata_sbs_gemFT_hit_ADCmaxsampUclust;
   Double_t        sbs_gemFT_hit_ADCmaxsampUclust[14];   //[Ndata.sbs.gemFT.hit.ADCmaxsampUclust]
   Int_t           Ndata_sbs_gemFT_hit_ADCmaxsampUclust_deconv;
   Double_t        sbs_gemFT_hit_ADCmaxsampUclust_deconv[14];   //[Ndata.sbs.gemFT.hit.ADCmaxsampUclust_deconv]
   Int_t           Ndata_sbs_gemFT_hit_ADCmaxsampV;
   Double_t        sbs_gemFT_hit_ADCmaxsampV[14];   //[Ndata.sbs.gemFT.hit.ADCmaxsampV]
   Int_t           Ndata_sbs_gemFT_hit_ADCmaxsampVclust;
   Double_t        sbs_gemFT_hit_ADCmaxsampVclust[14];   //[Ndata.sbs.gemFT.hit.ADCmaxsampVclust]
   Int_t           Ndata_sbs_gemFT_hit_ADCmaxsampVclust_deconv;
   Double_t        sbs_gemFT_hit_ADCmaxsampVclust_deconv[14];   //[Ndata.sbs.gemFT.hit.ADCmaxsampVclust_deconv]
   Int_t           Ndata_sbs_gemFT_hit_ADCmaxstripU;
   Double_t        sbs_gemFT_hit_ADCmaxstripU[14];   //[Ndata.sbs.gemFT.hit.ADCmaxstripU]
   Int_t           Ndata_sbs_gemFT_hit_ADCmaxstripV;
   Double_t        sbs_gemFT_hit_ADCmaxstripV[14];   //[Ndata.sbs.gemFT.hit.ADCmaxstripV]
   Int_t           Ndata_sbs_gemFT_hit_BUILD_ALL_SAMPLES_U;
   Double_t        sbs_gemFT_hit_BUILD_ALL_SAMPLES_U[14];   //[Ndata.sbs.gemFT.hit.BUILD_ALL_SAMPLES_U]
   Int_t           Ndata_sbs_gemFT_hit_BUILD_ALL_SAMPLES_V;
   Double_t        sbs_gemFT_hit_BUILD_ALL_SAMPLES_V[14];   //[Ndata.sbs.gemFT.hit.BUILD_ALL_SAMPLES_V]
   Int_t           Ndata_sbs_gemFT_hit_CM_GOOD_U;
   Double_t        sbs_gemFT_hit_CM_GOOD_U[14];   //[Ndata.sbs.gemFT.hit.CM_GOOD_U]
   Int_t           Ndata_sbs_gemFT_hit_CM_GOOD_V;
   Double_t        sbs_gemFT_hit_CM_GOOD_V[14];   //[Ndata.sbs.gemFT.hit.CM_GOOD_V]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC0_Umax;
   Double_t        sbs_gemFT_hit_DeconvADC0_Umax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC0_Umax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC0_Vmax;
   Double_t        sbs_gemFT_hit_DeconvADC0_Vmax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC0_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC1_Umax;
   Double_t        sbs_gemFT_hit_DeconvADC1_Umax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC1_Umax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC1_Vmax;
   Double_t        sbs_gemFT_hit_DeconvADC1_Vmax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC1_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC2_Umax;
   Double_t        sbs_gemFT_hit_DeconvADC2_Umax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC2_Umax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC2_Vmax;
   Double_t        sbs_gemFT_hit_DeconvADC2_Vmax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC2_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC3_Umax;
   Double_t        sbs_gemFT_hit_DeconvADC3_Umax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC3_Umax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC3_Vmax;
   Double_t        sbs_gemFT_hit_DeconvADC3_Vmax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC3_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC4_Umax;
   Double_t        sbs_gemFT_hit_DeconvADC4_Umax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC4_Umax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC4_Vmax;
   Double_t        sbs_gemFT_hit_DeconvADC4_Vmax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC4_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC5_Umax;
   Double_t        sbs_gemFT_hit_DeconvADC5_Umax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC5_Umax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADC5_Vmax;
   Double_t        sbs_gemFT_hit_DeconvADC5_Vmax[14];   //[Ndata.sbs.gemFT.hit.DeconvADC5_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADCmaxcomboU;
   Double_t        sbs_gemFT_hit_DeconvADCmaxcomboU[14];   //[Ndata.sbs.gemFT.hit.DeconvADCmaxcomboU]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADCmaxcomboV;
   Double_t        sbs_gemFT_hit_DeconvADCmaxcomboV[14];   //[Ndata.sbs.gemFT.hit.DeconvADCmaxcomboV]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADCmaxsampU;
   Double_t        sbs_gemFT_hit_DeconvADCmaxsampU[14];   //[Ndata.sbs.gemFT.hit.DeconvADCmaxsampU]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADCmaxsampV;
   Double_t        sbs_gemFT_hit_DeconvADCmaxsampV[14];   //[Ndata.sbs.gemFT.hit.DeconvADCmaxsampV]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADCmaxstripU;
   Double_t        sbs_gemFT_hit_DeconvADCmaxstripU[14];   //[Ndata.sbs.gemFT.hit.DeconvADCmaxstripU]
   Int_t           Ndata_sbs_gemFT_hit_DeconvADCmaxstripV;
   Double_t        sbs_gemFT_hit_DeconvADCmaxstripV[14];   //[Ndata.sbs.gemFT.hit.DeconvADCmaxstripV]
   Int_t           Ndata_sbs_gemFT_hit_ENABLE_CM_U;
   Double_t        sbs_gemFT_hit_ENABLE_CM_U[14];   //[Ndata.sbs.gemFT.hit.ENABLE_CM_U]
   Int_t           Ndata_sbs_gemFT_hit_ENABLE_CM_V;
   Double_t        sbs_gemFT_hit_ENABLE_CM_V[14];   //[Ndata.sbs.gemFT.hit.ENABLE_CM_V]
   Int_t           Ndata_sbs_gemFT_hit_TSchi2_Umax;
   Double_t        sbs_gemFT_hit_TSchi2_Umax[14];   //[Ndata.sbs.gemFT.hit.TSchi2_Umax]
   Int_t           Ndata_sbs_gemFT_hit_TSchi2_Vmax;
   Double_t        sbs_gemFT_hit_TSchi2_Vmax[14];   //[Ndata.sbs.gemFT.hit.TSchi2_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_TSprob_Umax;
   Double_t        sbs_gemFT_hit_TSprob_Umax[14];   //[Ndata.sbs.gemFT.hit.TSprob_Umax]
   Int_t           Ndata_sbs_gemFT_hit_TSprob_Vmax;
   Double_t        sbs_gemFT_hit_TSprob_Vmax[14];   //[Ndata.sbs.gemFT.hit.TSprob_Vmax]
   Int_t           Ndata_sbs_gemFT_hit_Tavg;
   Double_t        sbs_gemFT_hit_Tavg[14];   //[Ndata.sbs.gemFT.hit.Tavg]
   Int_t           Ndata_sbs_gemFT_hit_Tavg_corr;
   Double_t        sbs_gemFT_hit_Tavg_corr[14];   //[Ndata.sbs.gemFT.hit.Tavg_corr]
   Int_t           Ndata_sbs_gemFT_hit_Tavg_deconv;
   Double_t        sbs_gemFT_hit_Tavg_deconv[14];   //[Ndata.sbs.gemFT.hit.Tavg_deconv]
   Int_t           Ndata_sbs_gemFT_hit_Tavg_fit;
   Double_t        sbs_gemFT_hit_Tavg_fit[14];   //[Ndata.sbs.gemFT.hit.Tavg_fit]
   Int_t           Ndata_sbs_gemFT_hit_Ugain;
   Double_t        sbs_gemFT_hit_Ugain[14];   //[Ndata.sbs.gemFT.hit.Ugain]
   Int_t           Ndata_sbs_gemFT_hit_Utime;
   Double_t        sbs_gemFT_hit_Utime[14];   //[Ndata.sbs.gemFT.hit.Utime]
   Int_t           Ndata_sbs_gemFT_hit_UtimeDeconv;
   Double_t        sbs_gemFT_hit_UtimeDeconv[14];   //[Ndata.sbs.gemFT.hit.UtimeDeconv]
   Int_t           Ndata_sbs_gemFT_hit_UtimeFit;
   Double_t        sbs_gemFT_hit_UtimeFit[14];   //[Ndata.sbs.gemFT.hit.UtimeFit]
   Int_t           Ndata_sbs_gemFT_hit_UtimeMaxStrip;
   Double_t        sbs_gemFT_hit_UtimeMaxStrip[14];   //[Ndata.sbs.gemFT.hit.UtimeMaxStrip]
   Int_t           Ndata_sbs_gemFT_hit_UtimeMaxStripDeconv;
   Double_t        sbs_gemFT_hit_UtimeMaxStripDeconv[14];   //[Ndata.sbs.gemFT.hit.UtimeMaxStripDeconv]
   Int_t           Ndata_sbs_gemFT_hit_UtimeMaxStripFit;
   Double_t        sbs_gemFT_hit_UtimeMaxStripFit[14];   //[Ndata.sbs.gemFT.hit.UtimeMaxStripFit]
   Int_t           Ndata_sbs_gemFT_hit_Vgain;
   Double_t        sbs_gemFT_hit_Vgain[14];   //[Ndata.sbs.gemFT.hit.Vgain]
   Int_t           Ndata_sbs_gemFT_hit_Vtime;
   Double_t        sbs_gemFT_hit_Vtime[14];   //[Ndata.sbs.gemFT.hit.Vtime]
   Int_t           Ndata_sbs_gemFT_hit_VtimeDeconv;
   Double_t        sbs_gemFT_hit_VtimeDeconv[14];   //[Ndata.sbs.gemFT.hit.VtimeDeconv]
   Int_t           Ndata_sbs_gemFT_hit_VtimeFit;
   Double_t        sbs_gemFT_hit_VtimeFit[14];   //[Ndata.sbs.gemFT.hit.VtimeFit]
   Int_t           Ndata_sbs_gemFT_hit_VtimeMaxStrip;
   Double_t        sbs_gemFT_hit_VtimeMaxStrip[14];   //[Ndata.sbs.gemFT.hit.VtimeMaxStrip]
   Int_t           Ndata_sbs_gemFT_hit_VtimeMaxStripDeconv;
   Double_t        sbs_gemFT_hit_VtimeMaxStripDeconv[14];   //[Ndata.sbs.gemFT.hit.VtimeMaxStripDeconv]
   Int_t           Ndata_sbs_gemFT_hit_VtimeMaxStripFit;
   Double_t        sbs_gemFT_hit_VtimeMaxStripFit[14];   //[Ndata.sbs.gemFT.hit.VtimeMaxStripFit]
   Int_t           Ndata_sbs_gemFT_hit_adc_id_U;
   Double_t        sbs_gemFT_hit_adc_id_U[14];   //[Ndata.sbs.gemFT.hit.adc_id_U]
   Int_t           Ndata_sbs_gemFT_hit_adc_id_V;
   Double_t        sbs_gemFT_hit_adc_id_V[14];   //[Ndata.sbs.gemFT.hit.adc_id_V]
   Int_t           Ndata_sbs_gemFT_hit_ccor_clust;
   Double_t        sbs_gemFT_hit_ccor_clust[14];   //[Ndata.sbs.gemFT.hit.ccor_clust]
   Int_t           Ndata_sbs_gemFT_hit_ccor_clust_deconv;
   Double_t        sbs_gemFT_hit_ccor_clust_deconv[14];   //[Ndata.sbs.gemFT.hit.ccor_clust_deconv]
   Int_t           Ndata_sbs_gemFT_hit_ccor_strip;
   Double_t        sbs_gemFT_hit_ccor_strip[14];   //[Ndata.sbs.gemFT.hit.ccor_strip]
   Int_t           Ndata_sbs_gemFT_hit_ccor_strip_deconv;
   Double_t        sbs_gemFT_hit_ccor_strip_deconv[14];   //[Ndata.sbs.gemFT.hit.ccor_strip_deconv]
   Int_t           Ndata_sbs_gemFT_hit_crate_U;
   Double_t        sbs_gemFT_hit_crate_U[14];   //[Ndata.sbs.gemFT.hit.crate_U]
   Int_t           Ndata_sbs_gemFT_hit_crate_V;
   Double_t        sbs_gemFT_hit_crate_V[14];   //[Ndata.sbs.gemFT.hit.crate_V]
   Int_t           Ndata_sbs_gemFT_hit_deltat;
   Double_t        sbs_gemFT_hit_deltat[14];   //[Ndata.sbs.gemFT.hit.deltat]
   Int_t           Ndata_sbs_gemFT_hit_deltat_deconv;
   Double_t        sbs_gemFT_hit_deltat_deconv[14];   //[Ndata.sbs.gemFT.hit.deltat_deconv]
   Int_t           Ndata_sbs_gemFT_hit_deltat_fit;
   Double_t        sbs_gemFT_hit_deltat_fit[14];   //[Ndata.sbs.gemFT.hit.deltat_fit]
   Int_t           Ndata_sbs_gemFT_hit_eresidu;
   Double_t        sbs_gemFT_hit_eresidu[14];   //[Ndata.sbs.gemFT.hit.eresidu]
   Int_t           Ndata_sbs_gemFT_hit_eresidv;
   Double_t        sbs_gemFT_hit_eresidv[14];   //[Ndata.sbs.gemFT.hit.eresidv]
   Int_t           Ndata_sbs_gemFT_hit_icombomaxUclustDeconv;
   Double_t        sbs_gemFT_hit_icombomaxUclustDeconv[14];   //[Ndata.sbs.gemFT.hit.icombomaxUclustDeconv]
   Int_t           Ndata_sbs_gemFT_hit_icombomaxUstripDeconv;
   Double_t        sbs_gemFT_hit_icombomaxUstripDeconv[14];   //[Ndata.sbs.gemFT.hit.icombomaxUstripDeconv]
   Int_t           Ndata_sbs_gemFT_hit_icombomaxVclustDeconv;
   Double_t        sbs_gemFT_hit_icombomaxVclustDeconv[14];   //[Ndata.sbs.gemFT.hit.icombomaxVclustDeconv]
   Int_t           Ndata_sbs_gemFT_hit_icombomaxVstripDeconv;
   Double_t        sbs_gemFT_hit_icombomaxVstripDeconv[14];   //[Ndata.sbs.gemFT.hit.icombomaxVstripDeconv]
   Int_t           Ndata_sbs_gemFT_hit_isampmaxUclust;
   Double_t        sbs_gemFT_hit_isampmaxUclust[14];   //[Ndata.sbs.gemFT.hit.isampmaxUclust]
   Int_t           Ndata_sbs_gemFT_hit_isampmaxUclustDeconv;
   Double_t        sbs_gemFT_hit_isampmaxUclustDeconv[14];   //[Ndata.sbs.gemFT.hit.isampmaxUclustDeconv]
   Int_t           Ndata_sbs_gemFT_hit_isampmaxUstrip;
   Double_t        sbs_gemFT_hit_isampmaxUstrip[14];   //[Ndata.sbs.gemFT.hit.isampmaxUstrip]
   Int_t           Ndata_sbs_gemFT_hit_isampmaxUstripDeconv;
   Double_t        sbs_gemFT_hit_isampmaxUstripDeconv[14];   //[Ndata.sbs.gemFT.hit.isampmaxUstripDeconv]
   Int_t           Ndata_sbs_gemFT_hit_isampmaxVclust;
   Double_t        sbs_gemFT_hit_isampmaxVclust[14];   //[Ndata.sbs.gemFT.hit.isampmaxVclust]
   Int_t           Ndata_sbs_gemFT_hit_isampmaxVclustDeconv;
   Double_t        sbs_gemFT_hit_isampmaxVclustDeconv[14];   //[Ndata.sbs.gemFT.hit.isampmaxVclustDeconv]
   Int_t           Ndata_sbs_gemFT_hit_isampmaxVstrip;
   Double_t        sbs_gemFT_hit_isampmaxVstrip[14];   //[Ndata.sbs.gemFT.hit.isampmaxVstrip]
   Int_t           Ndata_sbs_gemFT_hit_isampmaxVstripDeconv;
   Double_t        sbs_gemFT_hit_isampmaxVstripDeconv[14];   //[Ndata.sbs.gemFT.hit.isampmaxVstripDeconv]
   Int_t           Ndata_sbs_gemFT_hit_layer;
   Double_t        sbs_gemFT_hit_layer[14];   //[Ndata.sbs.gemFT.hit.layer]
   Int_t           Ndata_sbs_gemFT_hit_module;
   Double_t        sbs_gemFT_hit_module[14];   //[Ndata.sbs.gemFT.hit.module]
   Int_t           Ndata_sbs_gemFT_hit_mpd_U;
   Double_t        sbs_gemFT_hit_mpd_U[14];   //[Ndata.sbs.gemFT.hit.mpd_U]
   Int_t           Ndata_sbs_gemFT_hit_mpd_V;
   Double_t        sbs_gemFT_hit_mpd_V[14];   //[Ndata.sbs.gemFT.hit.mpd_V]
   Int_t           Ndata_sbs_gemFT_hit_nstripu;
   Double_t        sbs_gemFT_hit_nstripu[14];   //[Ndata.sbs.gemFT.hit.nstripu]
   Int_t           Ndata_sbs_gemFT_hit_nstripv;
   Double_t        sbs_gemFT_hit_nstripv[14];   //[Ndata.sbs.gemFT.hit.nstripv]
   Int_t           Ndata_sbs_gemFT_hit_residu;
   Double_t        sbs_gemFT_hit_residu[14];   //[Ndata.sbs.gemFT.hit.residu]
   Int_t           Ndata_sbs_gemFT_hit_residv;
   Double_t        sbs_gemFT_hit_residv[14];   //[Ndata.sbs.gemFT.hit.residv]
   Int_t           Ndata_sbs_gemFT_hit_trackindex;
   Double_t        sbs_gemFT_hit_trackindex[14];   //[Ndata.sbs.gemFT.hit.trackindex]
   Int_t           Ndata_sbs_gemFT_hit_u;
   Double_t        sbs_gemFT_hit_u[14];   //[Ndata.sbs.gemFT.hit.u]
   Int_t           Ndata_sbs_gemFT_hit_umoment;
   Double_t        sbs_gemFT_hit_umoment[14];   //[Ndata.sbs.gemFT.hit.umoment]
   Int_t           Ndata_sbs_gemFT_hit_usigma;
   Double_t        sbs_gemFT_hit_usigma[14];   //[Ndata.sbs.gemFT.hit.usigma]
   Int_t           Ndata_sbs_gemFT_hit_ustriphi;
   Double_t        sbs_gemFT_hit_ustriphi[14];   //[Ndata.sbs.gemFT.hit.ustriphi]
   Int_t           Ndata_sbs_gemFT_hit_ustriplo;
   Double_t        sbs_gemFT_hit_ustriplo[14];   //[Ndata.sbs.gemFT.hit.ustriplo]
   Int_t           Ndata_sbs_gemFT_hit_ustripmax;
   Double_t        sbs_gemFT_hit_ustripmax[14];   //[Ndata.sbs.gemFT.hit.ustripmax]
   Int_t           Ndata_sbs_gemFT_hit_v;
   Double_t        sbs_gemFT_hit_v[14];   //[Ndata.sbs.gemFT.hit.v]
   Int_t           Ndata_sbs_gemFT_hit_vmoment;
   Double_t        sbs_gemFT_hit_vmoment[14];   //[Ndata.sbs.gemFT.hit.vmoment]
   Int_t           Ndata_sbs_gemFT_hit_vsigma;
   Double_t        sbs_gemFT_hit_vsigma[14];   //[Ndata.sbs.gemFT.hit.vsigma]
   Int_t           Ndata_sbs_gemFT_hit_vstriphi;
   Double_t        sbs_gemFT_hit_vstriphi[14];   //[Ndata.sbs.gemFT.hit.vstriphi]
   Int_t           Ndata_sbs_gemFT_hit_vstriplo;
   Double_t        sbs_gemFT_hit_vstriplo[14];   //[Ndata.sbs.gemFT.hit.vstriplo]
   Int_t           Ndata_sbs_gemFT_hit_vstripmax;
   Double_t        sbs_gemFT_hit_vstripmax[14];   //[Ndata.sbs.gemFT.hit.vstripmax]
   Int_t           Ndata_sbs_gemFT_hit_xglobal;
   Double_t        sbs_gemFT_hit_xglobal[14];   //[Ndata.sbs.gemFT.hit.xglobal]
   Int_t           Ndata_sbs_gemFT_hit_xlocal;
   Double_t        sbs_gemFT_hit_xlocal[14];   //[Ndata.sbs.gemFT.hit.xlocal]
   Int_t           Ndata_sbs_gemFT_hit_yglobal;
   Double_t        sbs_gemFT_hit_yglobal[14];   //[Ndata.sbs.gemFT.hit.yglobal]
   Int_t           Ndata_sbs_gemFT_hit_ylocal;
   Double_t        sbs_gemFT_hit_ylocal[14];   //[Ndata.sbs.gemFT.hit.ylocal]
   Int_t           Ndata_sbs_gemFT_hit_zglobal;
   Double_t        sbs_gemFT_hit_zglobal[14];   //[Ndata.sbs.gemFT.hit.zglobal]
   ...
   Double_t        sbs_gemFT_track_chi2ndf[2];   //[Ndata.sbs.gemFT.track.chi2ndf]
   Int_t           Ndata_sbs_gemFT_track_chi2ndf_hitquality;
   Double_t        sbs_gemFT_track_chi2ndf_hitquality[2];   //[Ndata.sbs.gemFT.track.chi2ndf_hitquality]
   Int_t           Ndata_sbs_gemFT_track_ngoodhits;
   Double_t        sbs_gemFT_track_ngoodhits[2];   //[Ndata.sbs.gemFT.track.ngoodhits]
   Int_t           Ndata_sbs_gemFT_track_nhits;
   Double_t        sbs_gemFT_track_nhits[2];   //[Ndata.sbs.gemFT.track.nhits]
   Int_t           Ndata_sbs_gemFT_track_t0;
   Double_t        sbs_gemFT_track_t0[2];   //[Ndata.sbs.gemFT.track.t0]
   Int_t           Ndata_sbs_gemFT_track_x;
   Double_t        sbs_gemFT_track_x[2];   //[Ndata.sbs.gemFT.track.x]
   Int_t           Ndata_sbs_gemFT_track_xp;
   Double_t        sbs_gemFT_track_xp[2];   //[Ndata.sbs.gemFT.track.xp]
   Int_t           Ndata_sbs_gemFT_track_y;
   Double_t        sbs_gemFT_track_y[2];   //[Ndata.sbs.gemFT.track.y]
   Int_t           Ndata_sbs_gemFT_track_yp;
   Double_t        sbs_gemFT_track_yp[2];   //[Ndata.sbs.gemFT.track.yp]
   Int_t           Ndata_sbs_hcal_clus_adctime;
   Double_t        sbs_hcal_clus_adctime[9];   //[Ndata.sbs.hcal.clus.adctime]
   Int_t           Ndata_sbs_hcal_clus_again;
   Double_t        sbs_hcal_clus_again[9];   //[Ndata.sbs.hcal.clus.again]
   Int_t           Ndata_sbs_hcal_clus_atimeblk;
   Double_t        sbs_hcal_clus_atimeblk[9];   //[Ndata.sbs.hcal.clus.atimeblk]
   Int_t           Ndata_sbs_hcal_clus_col;
   Double_t        sbs_hcal_clus_col[9];   //[Ndata.sbs.hcal.clus.col]
   Int_t           Ndata_sbs_hcal_clus_col_goodtdc;
   Double_t        sbs_hcal_clus_col_goodtdc[9];   //[Ndata.sbs.hcal.clus.col_goodtdc]
   Int_t           Ndata_sbs_hcal_clus_e;
   Double_t        sbs_hcal_clus_e[9];   //[Ndata.sbs.hcal.clus.e]
   Int_t           Ndata_sbs_hcal_clus_e_goodtdc;
   Double_t        sbs_hcal_clus_e_goodtdc[9];   //[Ndata.sbs.hcal.clus.e_goodtdc]
   Int_t           Ndata_sbs_hcal_clus_eblk;
   Double_t        sbs_hcal_clus_eblk[9];   //[Ndata.sbs.hcal.clus.eblk]
   Int_t           Ndata_sbs_hcal_clus_eblk_goodtdc;
   Double_t        sbs_hcal_clus_eblk_goodtdc[9];   //[Ndata.sbs.hcal.clus.eblk_goodtdc]
   Int_t           Ndata_sbs_hcal_clus_id;
   Double_t        sbs_hcal_clus_id[9];   //[Ndata.sbs.hcal.clus.id]
   Int_t           Ndata_sbs_hcal_clus_id_goodtdc;
   Double_t        sbs_hcal_clus_id_goodtdc[9];   //[Ndata.sbs.hcal.clus.id_goodtdc]
   Int_t           Ndata_sbs_hcal_clus_nblk;
   Double_t        sbs_hcal_clus_nblk[9];   //[Ndata.sbs.hcal.clus.nblk]
   Int_t           Ndata_sbs_hcal_clus_nblk_goodtdc;
   Double_t        sbs_hcal_clus_nblk_goodtdc[9];   //[Ndata.sbs.hcal.clus.nblk_goodtdc]
   Int_t           Ndata_sbs_hcal_clus_row;
   Double_t        sbs_hcal_clus_row[9];   //[Ndata.sbs.hcal.clus.row]
   Int_t           Ndata_sbs_hcal_clus_row_goodtdc;
   Double_t        sbs_hcal_clus_row_goodtdc[9];   //[Ndata.sbs.hcal.clus.row_goodtdc]
   Int_t           Ndata_sbs_hcal_clus_tdctime;
   Double_t        sbs_hcal_clus_tdctime[9];   //[Ndata.sbs.hcal.clus.tdctime]
   Int_t           Ndata_sbs_hcal_clus_tdctime_tw;
   Double_t        sbs_hcal_clus_tdctime_tw[9];   //[Ndata.sbs.hcal.clus.tdctime_tw]
   Int_t           Ndata_sbs_hcal_clus_tdctimeblk;
   Double_t        sbs_hcal_clus_tdctimeblk[9];   //[Ndata.sbs.hcal.clus.tdctimeblk]
   Int_t           Ndata_sbs_hcal_clus_tdctimeblk_tw;
   Double_t        sbs_hcal_clus_tdctimeblk_tw[9];   //[Ndata.sbs.hcal.clus.tdctimeblk_tw]
   Int_t           Ndata_sbs_hcal_clus_x;
   Double_t        sbs_hcal_clus_x[9];   //[Ndata.sbs.hcal.clus.x]
   Int_t           Ndata_sbs_hcal_clus_y;
   Double_t        sbs_hcal_clus_y[9];   //[Ndata.sbs.hcal.clus.y]
   ...
   Double_t        sbs_tr_beta[2];   //[Ndata.sbs.tr.beta]
   Int_t           Ndata_sbs_tr_chi2;
   Double_t        sbs_tr_chi2[2];   //[Ndata.sbs.tr.chi2]
   Int_t           Ndata_sbs_tr_d_ph;
   Double_t        sbs_tr_d_ph[2];   //[Ndata.sbs.tr.d_ph]
   Int_t           Ndata_sbs_tr_d_th;
   Double_t        sbs_tr_d_th[2];   //[Ndata.sbs.tr.d_th]
   Int_t           Ndata_sbs_tr_d_x;
   Double_t        sbs_tr_d_x[2];   //[Ndata.sbs.tr.d_x]
   Int_t           Ndata_sbs_tr_d_y;
   Double_t        sbs_tr_d_y[2];   //[Ndata.sbs.tr.d_y]
   Int_t           Ndata_sbs_tr_dbeta;
   Double_t        sbs_tr_dbeta[2];   //[Ndata.sbs.tr.dbeta]
   Int_t           Ndata_sbs_tr_dtime;
   Double_t        sbs_tr_dtime[2];   //[Ndata.sbs.tr.dtime]
   Int_t           Ndata_sbs_tr_flag;
   Double_t        sbs_tr_flag[2];   //[Ndata.sbs.tr.flag]
   Int_t           Ndata_sbs_tr_ndof;
   Double_t        sbs_tr_ndof[2];   //[Ndata.sbs.tr.ndof]
   Int_t           Ndata_sbs_tr_p;
   Double_t        sbs_tr_p[2];   //[Ndata.sbs.tr.p]
   Int_t           Ndata_sbs_tr_pathl;
   Double_t        sbs_tr_pathl[2];   //[Ndata.sbs.tr.pathl]
   Int_t           Ndata_sbs_tr_ph;
   Double_t        sbs_tr_ph[2];   //[Ndata.sbs.tr.ph]
   Int_t           Ndata_sbs_tr_px;
   Double_t        sbs_tr_px[2];   //[Ndata.sbs.tr.px]
   Int_t           Ndata_sbs_tr_py;
   Double_t        sbs_tr_py[2];   //[Ndata.sbs.tr.py]
   Int_t           Ndata_sbs_tr_pz;
   Double_t        sbs_tr_pz[2];   //[Ndata.sbs.tr.pz]
   Int_t           Ndata_sbs_tr_r_ph;
   Double_t        sbs_tr_r_ph[2];   //[Ndata.sbs.tr.r_ph]
   Int_t           Ndata_sbs_tr_r_th;
   Double_t        sbs_tr_r_th[2];   //[Ndata.sbs.tr.r_th]
   Int_t           Ndata_sbs_tr_r_x;
   Double_t        sbs_tr_r_x[2];   //[Ndata.sbs.tr.r_x]
   Int_t           Ndata_sbs_tr_r_y;
   Double_t        sbs_tr_r_y[2];   //[Ndata.sbs.tr.r_y]
   Int_t           Ndata_sbs_tr_tg_dp;
   Double_t        sbs_tr_tg_dp[2];   //[Ndata.sbs.tr.tg_dp]
   Int_t           Ndata_sbs_tr_tg_ph;
   Double_t        sbs_tr_tg_ph[2];   //[Ndata.sbs.tr.tg_ph]
   Int_t           Ndata_sbs_tr_tg_th;
   Double_t        sbs_tr_tg_th[2];   //[Ndata.sbs.tr.tg_th]
   Int_t           Ndata_sbs_tr_tg_y;
   Double_t        sbs_tr_tg_y[2];   //[Ndata.sbs.tr.tg_y]
   Int_t           Ndata_sbs_tr_th;
   Double_t        sbs_tr_th[2];   //[Ndata.sbs.tr.th]
   Int_t           Ndata_sbs_tr_time;
   Double_t        sbs_tr_time[2];   //[Ndata.sbs.tr.time]
   Int_t           Ndata_sbs_tr_vx;
   Double_t        sbs_tr_vx[2];   //[Ndata.sbs.tr.vx]
   Int_t           Ndata_sbs_tr_vy;
   Double_t        sbs_tr_vy[2];   //[Ndata.sbs.tr.vy]
   Int_t           Ndata_sbs_tr_vz;
   Double_t        sbs_tr_vz[2];   //[Ndata.sbs.tr.vz]
   Int_t           Ndata_sbs_tr_x;
   Double_t        sbs_tr_x[2];   //[Ndata.sbs.tr.x]
   Int_t           Ndata_sbs_tr_y;
   Double_t        sbs_tr_y[2];   //[Ndata.sbs.tr.y]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/volatile/halla/sbs/puckett/g4sbs_output/GEP1/elastic/replayed/rootfiles/replayed_GEP1_elastic_all.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/volatile/halla/sbs/puckett/g4sbs_output/GEP1/elastic/replayed/rootfiles/replayed_GEP1_elastic_all.root");
      }
      f->GetObject("T",tree);
