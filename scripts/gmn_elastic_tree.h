...
// Fri Aug 16 16:12:00 2024 by ROOT version 6.32.00
// from TTree Tout/Tree containing variables for momentum calibration
// found on file: Elastic_SBS8_LH2_100percent.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        thetapq_n;
   Double_t        thetapq_p;
   Double_t        thetapq_n_4vect;
   Double_t        thetapq_p_4vect;
   Double_t        thetapq_p_exact;
   Double_t        thetapq_p_exact_4vect;
   Double_t        deltat;
   Double_t        deltat_adc;
   Double_t        deltax_4vect;
   Double_t        deltay_4vect;
   Double_t        protondeflection;
   Double_t        protondeflection_exact;
   Double_t        protondeflection_4vect;
   Double_t        protondeflection_exact_4vect;
   Int_t           ibest_HCAL;
   Int_t           nblkHCAL;
   Double_t        againblkHCAL[26];   //[nblkHCAL]
   Double_t        atimeblkHCAL[26];   //[nblkHCAL]
   Double_t        eblkHCAL[26];   //[nblkHCAL]
   Double_t        idblkHCAL[26];   //[nblkHCAL]
   Double_t        rowblkHCAL[26];   //[nblkHCAL]
   Double_t        colblkHCAL[26];   //[nblkHCAL]
   Double_t        xblkHCAL[26];   //[nblkHCAL]
   Double_t        yblkHCAL[26];   //[nblkHCAL]
   Int_t           grinch_clsize;
   Int_t           grinch_tridx;
   ...
   TBranch        *b_thetapq_n;   //!
   TBranch        *b_thetapq_p;   //!
   TBranch        *b_thetapq_n_4vect;   //!
   TBranch        *b_thetapq_p_4vect;   //!
   TBranch        *b_thetapq_p_exact;   //!
   TBranch        *b_thetapq_p_exact_4vect;   //!
   TBranch        *b_deltat;   //!
   TBranch        *b_deltat_ADC;   //!
   TBranch        *b_deltax_4vect;   //!
   TBranch        *b_deltay_4vect;   //!
   TBranch        *b_protondeflection;   //!
   TBranch        *b_protondeflection_exact;   //!
   TBranch        *b_protondeflection_4vect;   //!
   TBranch        *b_protondeflection_exact_4vect;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Elastic_SBS8_LH2_100percent.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Elastic_SBS8_LH2_100percent.root");
      }
...
void gmn_elastic_tree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("epsilon_inel", &epsilon_inel, &b_epsilon_inel);
   ...
   fChain->SetBranchAddress("thetapq_p", &thetapq_p, &b_thetapq_p);
   fChain->SetBranchAddress("thetapq_n_4vect", &thetapq_n_4vect, &b_thetapq_n_4vect);
   fChain->SetBranchAddress("thetapq_p_4vect", &thetapq_p_4vect, &b_thetapq_p_4vect);
   fChain->SetBranchAddress("thetapq_p_exact", &thetapq_p_exact, &b_thetapq_p_exact);
   fChain->SetBranchAddress("thetapq_p_exact_4vect", &thetapq_p_exact_4vect, &b_thetapq_p_exact_4vect);
   ...
   fChain->SetBranchAddress("protondeflection_exact", &protondeflection_exact, &b_protondeflection_exact);
   fChain->SetBranchAddress("protondeflection_4vect", &protondeflection_4vect, &b_protondeflection_4vect);
   fChain->SetBranchAddress("protondeflection_exact_4vect", &protondeflection_exact_4vect, &b_protondeflection_exact_4vect);
